  ...
  return (
    <div className="flex lg:flex-row flex-col items-center justify-center mt-14 lg:mx-8 mx-4">
      <div className="lg:w-[50%] w-full lg:text-2xl text-xl text-gray-400 font-medium lg:mb-0 mb-6">
        ...
        decided to try make the computer say hello — turns out hacking together
        a very dumb but insanely great product taught me a lot about this whole new world! Fast-forward to
        today, and I’ve had the privilege of working at a 
        start-up, a small but very creative team, a huge corporation, and a design studio. My main
