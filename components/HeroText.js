...
const HeroText = () => {
    ...
    return (
        <div className="relative group first">
            ...
            className="text text-[#1D1D1F] font-bold lg:text-[9rem] text-[3.5rem] tracking-tighter whitespace-nowrap lg:leading-[105px] leading-[50px] z-10 opacity-100">Curious<br></br>developer,<br></br>crafter,<br></br>storyteller</motion.p>
